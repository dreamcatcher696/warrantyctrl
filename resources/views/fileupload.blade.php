  ...
  @if (count($errors))
    ...
    <form method="POST" action="files/upload" enctype="multipart/form-data" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input class="form-control" type="text" name="titel" placeholder="voeg een titel toe" value="{{old('titel')=='' ? '' : old('titel')}}"></input>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="aankoop_datum">Aankoopdatum</label>
        <div class="col-sm-10">
          <input class="form-control" type="date" name="aankoop_datum" value="{{old('aankoop_datum')=='' ? '' : old('aankoop_datum')}}"></input>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="verloop_datum">Verloopt op</label>
        <div class="col-sm-10">
          <input class="form-control" type="date" name="verloop_datum" value="{{old('verloop_datum')=='' ? '' : old('verloop_datum')}}"></input>
        </div>
      </div>
      <div class="form-group">
